...
/* harmony import */ var _TableRow_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TableRow.vue */ "./resources/js/components/TableRow.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['card'],
  components: {
    TableRow: _TableRow_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  created: function created() {
    var _this$card = this.card,
        header = _this$card.header,
        rows = _this$card.rows,
        title = _this$card.title,
        paginator = _this$card.paginator;
    this.header = header;
    this.title = title;
    this.rows = rows;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_0__.Paginatable, laravel_nova__WEBPACK_IMPORTED_MODULE_0__.PerPageable],
  data: function data() {
    return {
  ...
  computed: {
    resourceCountLabel: function resourceCountLabel() {
      ...
      return this.modelValue.data.length && "".concat(first + 1, "-").concat(first + this.modelValue.data.length, " ").concat(this.__('of'), " ").concat(this.allMatchingResourceCount);
    },
  ...
  methods: {
    selectPage: function selectPage(page) {
      ...
      Nova.request().get(this.path, {
        ...
        var paginationCard = response.data.cards.find(function (card) {
          return card.component === 'nova-custom-table-card';
        });

        _this.$emit('update:modelValue', paginationCard.paginator);

        _this.$emit('updateRows', paginationCard.rows);

        if (paginationCard.paginator !== undefined) {
          _this.perPage = paginationCard.paginator.per_page;
          _this.allMatchingResourceCount = paginationCard.paginator.total;
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT, PROPS */
  , _hoisted_4)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.paginator ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_Pagination, {
    key: 2,
    modelValue: $data.paginator,
    "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
      return $data.paginator = $event;
    }),
    onUpdateRows: $options.update
  }, null, 8
  /* PROPS */
  , ["modelValue", "onUpdateRows"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_pagination_links, {
    is: $options.paginationComponent,
    "all-matching-resource-count": _ctx.allMatchingResourceCount,
    "current-resource-count": $props.modelValue.data.length,
    next: $options.hasNextPage,
    page: _ctx.currentPage,
    pages: $options.totalPages,
    "per-page": _ctx.perPage,
    previous: $options.hasPreviousPage,
    "resource-count-label": $options.resourceCountLabel,
    onPage: $options.selectPage
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$options.resourceCountLabel ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
        key: 0,
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([{
          'ml-auto': $options.paginationComponent === 'pagination-links'
        }, "text-sm text-80 px-4"])
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.resourceCountLabel), 3
      /* TEXT, CLASS */
  ...
  /* PROPS */
  , ["is", "all-matching-resource-count", "current-resource-count", "next", "page", "pages", "per-page", "previous", "resource-count-label", "onPage"])]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* KEYED_FRAGMENT */
    ...
    }, "text-center dark:bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900"])
  }, [$props.row.view ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    href: $props.row.view,
...
Nova.booting(function (Vue, router, store) {
  Vue.component('nova-custom-table-card', _components_Card__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/* harmony import */ var _Users_joeriverstraete_Code_Joeri_custom_table_card_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_joeriverstraete_Code_Joeri_custom_table_card_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Card_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Card_vue_vue_type_template_id_b9bc2c0a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/Card.vue"]])
/* hot reload */
if (false) {}
